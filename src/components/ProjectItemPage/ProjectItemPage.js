		...
		return(
			<Wrapper className='content'>
				<div className='content__row'>
					<img 
						srcSet={require('../../data/' + this.props.url + '/' + this.props.url + '_main.jpg') + ' 1x, ' + require('../../data/' + this.props.url + '/' + this.props.url + '_main@2x.jpg') + ' 2x'}
									...
									row.map((image, j) => {
										...
										return(
											<img
												...
												srcSet={require('../../data/' + this.props.url + '/' + image) + ' 1x, ' + require('../../data/' + this.props.url + '/' + image2x) + ' 2x'} 

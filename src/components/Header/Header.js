...
class Header extends Component {
    ...
    render() {
        ...
        let headerPanelClassName = this.props.menuOpened ? 'Header__container Header__container--contact' : 'Header__container Header__container--contact Header__container--hidden';
